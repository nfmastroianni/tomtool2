...
function copySheet(grade, language, ss) {
    ...
    var ts = SpreadsheetApp.openById("1j_oLC33TnsnTFGY0-7UNtSq9eOB4bWY1_41t5YGonA8");
    var sheetToCopy = ts.getSheetByName(sheetName);
    sheetToCopy.copyTo(ss);
}

function fillHeading(record, sheet) {
    var d = new Date(record['Result_Date']);
...
function fillELA(record, sheet) {
    var ela = {
        ...
        "ELA_5-8_(Concepts_of_Print)": {
            ...
            "Difference between letters and words": "G61",
        ...
        "ELA_5-8_(Reading_Literature)": {
            ...
            "Discusses several things about the book": "G65",
        ...
        "ELA_9-12_(Reading_Informational)": {
            ...
            "Describes a fact from the text with detail": "G69",
        ...
        "ELA_9-12_(Vocabulary)": {
            ...
            "Applies the word in new situation": "G73",
        ...
        "ELA_9-12_(Graphics_Practice)": {
            ...
            "Motor movement for Level 4-5 figures": "G81",
...
function fillMath(record, sheet) {
    var math = {
        ...
        "Math_1-2_(Recognizing_Numbers)": {
            ...
            "Recognizes and writes numbers 1-10": "G90",
        ...
        "Math_3-5_(Shapes)": {
            ...
            "Recognizes and names 3D shapes": "G94",
